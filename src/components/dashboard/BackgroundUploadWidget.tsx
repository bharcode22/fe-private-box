          ...
          <div className="w-[95vw] max-w-2xl sm:w-[600px] min-h-[300px] sm:min-h-[350px] flex flex-col justify-between gap-8 rounded-3xl glass-card border border-indigo-500/30 p-8 sm:p-10 shadow-2xl backdrop-blur-xl relative bg-slate-950/90">
            ...
            <div className="flex items-center justify-between pt-1 border-t border-slate-800/60 text-[10px] text-slate-400">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 hover:text-rose-300 text-xs font-semibold border border-rose-500/20 hover:border-rose-500/30 transition-all cursor-pointer shadow-sm shadow-rose-500/5 active:scale-95 flex items-center justify-center"
              >
                Batal
              </button>
            </div>
